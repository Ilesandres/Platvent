...
```
esta aplicacion web queda hasta aquí probablemente, presente una que otra actualizacion, pero no seran constantes, sientete libre de usar el codigo como creas correspondiente.
```
